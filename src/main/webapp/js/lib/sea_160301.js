...
(function() {
	...
	seajs.config({
		...
		alias: {
			...
			'module/UserInfo': 'module/UserInfo.js',
			'module/GameUserInfo': 'module/GameUserInfo.js',
			'module/OrgList': 'module/OrgList.js',
			'module/TeacherList': 'module/TeacherList.js',
			'module/Validator': 'module/Validator.js',
			'page/login': 'page/login.js',
			'util/artTemplate': 'util/artTemplate_150909.js',
			'util/chainCity': 'util/chainCity.js',
